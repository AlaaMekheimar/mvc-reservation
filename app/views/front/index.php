...
<head>
  ...
  <!-- 
    - favicon
  -->
  <link rel="shortcut icon" href="<?= CSS_PATH?>front/favicon.svg" type="image/svg+xml">
  ...
  <!-- 
    - custom css link
  -->
  <link rel="stylesheet" href="<?= CSS_PATH?>front/css/style.css">

  <!-- 
    - preload images
  -->
  <link rel="preload" as="image" href="<?= CSS_PATH?>front/images/hero-slider-1.jpg">
  <link rel="preload" as="image" href="<?= CSS_PATH?>front/images/hero-slider-2.jpg">
  <link rel="preload" as="image" href="<?= CSS_PATH?>front/images/hero-slider-3.jpg">
...
<body id="top">
  ...
  <header class="header" data-header>
    <div class="container">
      ...
      <a href="#" class="logo">
        <img src="<?= CSS_PATH?>front/images/logo.svg" width="160" height="50" alt="Grilli - Home">
      </a>
    ...
    <article>
      ...
      <section class="hero text-center" aria-label="home" id="home">
        ...
        <ul class="hero-slider" data-hero-slider>
          ...
          <li class="slider-item active" data-hero-slider-item>
            ...
            <div class="slider-bg">
              <img src="<?= CSS_PATH?>front/images/hero-slider-1.jpg" width="1880" height="950" alt="" class="img-cover">
            </div>
          ...
          <li class="slider-item" data-hero-slider-item>
            ...
            <div class="slider-bg">
              <img src="<?= CSS_PATH?>front/images/hero-slider-2.jpg" width="1880" height="950" alt="" class="img-cover">
            </div>
          ...
          <li class="slider-item" data-hero-slider-item>
            ...
            <div class="slider-bg">
              <img src="<?= CSS_PATH?>front/images/hero-slider-3.jpg" width="1880" height="950" alt="" class="img-cover">
            </div>
        ...
        <a href="#" class="hero-btn has-after">
          <img src="<?= CSS_PATH?>front/images/hero-icon.png" width="48" height="48" alt="booking icon">
      ...
      <section class="section service bg-black-10 text-center" aria-label="service">
        <div class="container">
          ...
          <ul class="grid-list">
              ...
              <div class="service-card">
                ...
                <a href="#" class="has-before hover:shine">
                  <figure class="card-banner img-holder" style="--width: 285; --height: 336;">
                    <img src="<?= CSS_PATH?>front/images/service-1.jpg" width="285" height="336" loading="lazy" alt="Breakfast"
                      class="img-cover">
                  </figure>
                </a>
            ...
            <li>
              <div class="service-card">
                ...
                <a href="#" class="has-before hover:shine">
                  <figure class="card-banner img-holder" style="--width: 285; --height: 336;">
                    <img src="<?= CSS_PATH?>front/images/service-2.jpg" width="285" height="336" loading="lazy" alt="Appetizers"
                      class="img-cover">
                  </figure>
                </a>
            ...
            <li>
              <div class="service-card">
                ...
                <a href="#" class="has-before hover:shine">
                  <figure class="card-banner img-holder" style="--width: 285; --height: 336;">
                    <img src="<?= CSS_PATH?>front/images/service-3.jpg" width="285" height="336" loading="lazy" alt="Drinks"
                      class="img-cover">
                  </figure>
                </a>
          ...
          <img src="<?= CSS_PATH?>front/images/shape-1.png" width="246" height="412" loading="lazy" alt="shape"
            class="shape shape-1 move-anim">
          <img src="<?= CSS_PATH?>front/images/shape-2.png" width="343" height="345" loading="lazy" alt="shape"
      ...
      <section class="section about text-center" aria-labelledby="about-label" id="about">
        <div class="container">
          ...
          <figure class="about-banner">
            ...
            <img src="<?= CSS_PATH?>front/images/about-banner.jpg" width="570" height="570" loading="lazy" alt="about banner"
              class="w-100" data-parallax-item data-parallax-speed="1">

            <div class="abs-img abs-img-1 has-before" data-parallax-item data-parallax-speed="1.75">
              <img src=".<?= CSS_PATH?>front/images/about-abs-image.jpg" width="285" height="285" loading="lazy" alt=""
                class="w-100">
            </div>

            <div class="abs-img abs-img-2 has-before">
              <img src="<?= CSS_PATH?>front/images/badge-2.png" width="133" height="134" loading="lazy" alt="">
            </div>

          </figure>

          <img src="<?= CSS_PATH?>front/images/shape-3.png" width="197" height="194" loading="lazy" alt="" class="shape">
      ...
      <section class="special-dish text-center" aria-labelledby="dish-label">
        ...
        <div class="special-dish-banner">
          <img src="<?= CSS_PATH?>front/images/special-dish-banner.jpg" width="940" height="900" loading="lazy" alt="special dish"
            class="img-cover">
        </div>
        ...
        <div class="special-dish-content bg-black-10">
          <div class="container">
            ...
            <img src="<?= CSS_PATH?>front/images/badge-1.png" width="28" height="41" loading="lazy" alt="badge" class="abs-img">
        ...
        <img src="<?= CSS_PATH?>front/images/shape-4.png" width="179" height="359" loading="lazy" alt="" class="shape shape-1">

        <img src="<?= CSS_PATH?>front/images/shape-9.png" width="351" height="462" loading="lazy" alt="" class="shape shape-2">
...
<?php foreach($data as $ad):?>
            <li>
              <div class="menu-card hover:card">
                ...
                <figure class="card-banner img-holder" style="--width: 100; --height: 100;">
                  <img src="<?=CSS_PATH;?>img/<?=$ad['img']?>" width="100" height="100" loading="lazy" alt="Greek Salad"
                    class="img-cover">
                </figure>
                ...
                <div>
                  ...
                  <div class="title-wrapper">
                    ...
                    <span class="span title-2"><?=$ad['price'];?></span>
                  </div>
          ...
          <img src="<?= CSS_PATH?>front/images/shape-5.png" width="921" height="1036" loading="lazy" alt="shape"
            class="shape shape-2 move-anim">
          <img src="<?= CSS_PATH?>front/images/shape-6.png" width="343" height="345" loading="lazy" alt="shape"
      ...
      <section class="section testi text-center has-bg-image"
        style="background-image: url('<?= CSS_PATH?>front/images/testimonial-bg.jpg')" aria-label="testimonials">
        <div class="container">
          ...
          <div class="profile">
            <img src="<?= CSS_PATH?>front/images/testi-avatar.jpg" width="100" height="100" loading="lazy" alt="Sam Jhonson"
              class="img">
      ...
      <section class="reservation">
        <div class="container">
          ...
          <div class="form reservation-form bg-black-10">
            ...
            <form action="<?=CSS_PATH?>home/postreservation" method="post" class="form-left">
              ...
              <div class="input-wrapper">
                ...
                <div class="icon-wrapper">
                  <ion-icon name="times" aria-hidden="true"></ion-icon>
      ...
      <section class="section features text-center" aria-label="features">
        <div class="container">
          ...
          <ul class="grid-list">
            ...
            <li class="feature-item">
              <div class="feature-card">
                ...
                <div class="card-icon">
                  <img src="<?= CSS_PATH?>front/images/features-icon-1.png" width="100" height="80" loading="lazy" alt="icon">
                </div>
            ...
            <li class="feature-item">
              <div class="feature-card">
                ...
                <div class="card-icon">
                  <img src="<?= CSS_PATH?>front/images/features-icon-2.png" width="100" height="80" loading="lazy" alt="icon">
                </div>
            ...
            <li class="feature-item">
              <div class="feature-card">
                ...
                <div class="card-icon">
                  <img src="<?= CSS_PATH?>front/images/features-icon-3.png" width="100" height="80" loading="lazy" alt="icon">
                </div>
            ...
            <li class="feature-item">
              <div class="feature-card">
                ...
                <div class="card-icon">
                  <img src="<?= CSS_PATH?>front/images/features-icon-4.png" width="100" height="80" loading="lazy" alt="icon">
                </div>
          ...
          <img src="<?= CSS_PATH?>front/images/shape-7.png" width="208" height="178" loading="lazy" alt="shape"
            class="shape shape-1">

          <img src="<?= CSS_PATH?>front/images/shape-8.png" width="120" height="115" loading="lazy" alt="shape"
            class="shape shape-2">
          ...
          <ul class="grid-list">
            ...
            <li>
              <div class="event-card has-before hover:shine">
                ...
                <div class="card-banner img-holder" style="--width: 350; --height: 450;">
                  <img src="<?= CSS_PATH?>front/images/event-1.jpg" width="350" height="450" loading="lazy"
            ...
            <li>
              <div class="event-card has-before hover:shine">
                ...
                <div class="card-banner img-holder" style="--width: 350; --height: 450;">
                  <img src="<?= CSS_PATH?>front/images/event-2.jpg" width="350" height="450" loading="lazy"
                    alt="Flavour so good you’ll try to eat with your eyes." class="img-cover">
            ...
            <li>
              <div class="event-card has-before hover:shine">
                ...
                <div class="card-banner img-holder" style="--width: 350; --height: 450;">
                  <img src="<?= CSS_PATH?>front/images/event-3.jpg" width="350" height="450" loading="lazy"
                    alt="Flavour so good you’ll try to eat with your eyes." class="img-cover">
  ...
  <footer class="footer section has-bg-image text-center"
    style="background-image: url('<?= CSS_PATH?>front/images/footer-bg.jpg')">
    <div class="container">
      ...
      <div class="footer-top grid-list">
        ...
        <div class="footer-brand has-before has-after">
          ...
          <a href="#" class="logo">
            <img src="<?= CSS_PATH?>front/images/logo.svg" width="160" height="50" loading="lazy" alt="grilli home">
          </a>
  ...
  <!-- 
    - custom js link
  -->
  <script src="<?= CSS_PATH?>front/js/script.js"></script>
